...
Wasabi.module.info = {"functions":[{"type":"|","import":null,"export":["test"],"locals":"","instrCount":801},{"type":"iii|i","import":null,"export":["checkRange"],"locals":"","instrCount":23}],"globals":"","start":null,"tables":[],"tableExportName":null,"brTables":[],"originalFunctionImportsCount":0};

Wasabi.module.lowlevelHooks = {
"begin_function": function (func, instr, ) {
    Wasabi.analysis.begin({func, instr}, "function");
},
"memory_fill": function (func, instr, size, value, destination) {
    Wasabi.analysis.memory_fill({func, instr}, size, value, destination);
},
"memory_copy": function (func, instr, size, source, destination) {
    Wasabi.analysis.memory_copy({func, instr}, size, source, destination);
},
